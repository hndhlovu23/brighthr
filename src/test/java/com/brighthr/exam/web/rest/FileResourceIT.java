...
class FileResourceIT {
    ...
    private static final Date UPDATED_DATE = Date.valueOf(LocalDate.now());
    ...
    public static File createEntity(EntityManager em) {
        ...
        file.setAdded(DEFAULT_DATE);
        file.setFileUrl((DEFAULT_FILE_URL));
    ...
    public static File createUpdatedEntity(EntityManager em) {
        File file = new File();
        file.setName(UPDATED_NAME);
        file.setAdded(UPDATED_DATE);
        file.setFileUrl(UPDATED_FILE_URL);
        return file;
    }
    ...
    void createFile() throws Exception {
        ...
        assertThat(testFile.getAdded()).isEqualTo(DEFAULT_DATE);
    ...
    void putExistingFile() throws Exception {
        ...
        updatedFile.setAdded(UPDATED_DATE);
        updatedFile.setFileUrl(UPDATED_FILE_URL);
        ...
        assertThat(testFile.getAdded()).isEqualTo(UPDATED_DATE);
    ...
    void partialUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.setName(UPDATED_NAME);
    ...
    void fullUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.setName(UPDATED_NAME);
        partialUpdatedFile.setAdded(UPDATED_DATE);
        partialUpdatedFile.setFileUrl(UPDATED_FILE_URL);
