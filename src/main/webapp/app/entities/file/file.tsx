...
import { getEntities, searchAllEntitiesByName } from './file.reducer';
...
export const File = () => {
  ...
  const handleSearch = () => {
    dispatch(searchAllEntitiesByName({ name: searchQuery }));
  };
  ...
  return (
    <div>
      ...
      <div className="mb-3">
        <Input type="text" name="search" id="search" placeholder="Search by file name" value={searchQuery} onChange={handleInputChange} />
