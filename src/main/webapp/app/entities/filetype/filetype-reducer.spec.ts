...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './filetype.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IFiletype, defaultValue } from 'app/shared/model/filetype.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILETYPE actions', async () => {
      const expectedActions = [
        {
