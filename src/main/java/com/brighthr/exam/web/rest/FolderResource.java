...
/**
 * REST controller for managing {@link com.brighthr.exam.domain.Folder}.
 */
@RestController
@RequestMapping("/api")
public class FolderResource {
     ...
     */
    @GetMapping("/folders")
    public ResponseEntity<List<FolderDTO>> getAllFolders(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
