...
BrightHR File Browser (Tech Task)
Welcome to BrightHR File Browser, a web application designed to provide an efficient interface for managing and navigating files and folders. Built using Spring Boot for the backend and React.js for the frontend, this application is deployed on Azure for optimal performance and scalability.
Features
...
To build the final jar and optimize the brighthr application for production, run:
